 	<!-- Main Header-->
    <header  page="inc_main_header-2"  class="main-header header-style-two">
		<div class="auto-container clearfix">
            ...
            <div class="header-top clearfix">
                ...
                <div class="top-right pull-right clearfix">
                    <div class="request-btn"><i class="flaticon-right-arrow-3"></i><a href="index.php">Request for Demo</a></div>
                            ...
                            <ul class="navigation clearfix">
                                <li class="current dropdown"><a href="#">Home</a>
                                    <ul>
                                        ...
                                        <li><a href="index_2.php">Home Style Two</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown"><a href="#">Cases</a>
                                    <ul>
                                        <li><a href="case.php">Case Style 01</a></li>
                                        <li><a href="case_2.php">Case Style 02</a></li>
                                        <li><a href="case_3.php">Case Style 03</a></li>
                                        <li><a href="case_details.php">Case Detail</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">Our Services</a>
                                    <ul>
                                        <li><a href="services_style_01.php">Services Style 01</a></li>
                                        <li><a href="services_style_02.php">Services Style 02</a></li>
                                        <li><a href="corporate_law.php">Corporate Law</a></li>
                                        <li><a href="real_estate_law.php">Real Estate Law</a></li>
                                        <li><a href="insurance_law.php">Insurance Law</a></li>
